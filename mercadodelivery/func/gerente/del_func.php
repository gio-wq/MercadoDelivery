...
<?php
 ...
 ?>
  ...
  <img src='https://ca12a97fef467f0a0fc5-5680361a3407f33f45d506504554a5a0.ssl.cf3.rackcdn.com/entries/h/e_h0at7w77/posters/4043.jpg' id='background-img'>
	<center>
	<div class='conteudo'>
	<form name='del-func' method='post' action='\mercadodelivery/func/gerente/del-func.php'>
		<p><label>Nome do Funcion&aacute;rio:</label>
		<input type='text' maxlength='250' name='nome_func' required/></p>

		<p><label>CPF do Funcion&aacute;rio:</label>
		<input type='text' name='cpf_func' maxlength='14' required/>
		</p>
